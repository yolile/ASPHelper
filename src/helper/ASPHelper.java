...
public class ASPHelper {
    ...
    public Set<String> getPrimeroProduccion(Produccion variable) {
    ...
    private List<String> primero(String variable, List<String> cPrimero) {
            ...
            if (prod.getIzquierda().equals(variable) && !prod.isProcesado()) {
                ...
                for (int i = 0; i < prod.getDerecha().size() - 1; i++) {
                    ...
                    if (temp.contains(VACIO)) {
                        primero(prod.getDerecha().get(i + 1), cPrimero);
    ...
    public List<String> primero(Produccion produccion, List<String> cPrimero) {
